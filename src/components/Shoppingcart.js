            ...
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="customized table">
                ...
                <TableBody>
                  ...
                  {popOverDesc && <Popover style={{ width: '800px' }}
                  ...
                  <TableRow >
                    ...
                    <StyledTableCell className="cartTotal" align="right"></StyledTableCell>
                    <StyledTableCell className="cartTotal" align="right"></StyledTableCell>
                    <StyledTableCell className="cartTotal" align="right"><b>{totalCost.toFixed(2) + ' $'}</b></StyledTableCell>
